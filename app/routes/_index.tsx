  ...
  return (
    <>
      ...
      <div className="page">
        ...
        {/* Demos Section (Static & Interactive Side-by-Side) */}
        <section className="demos-container">
          <h2 className="section-heading" style={{ marginBottom: "1rem" }}>Hear it in action. Or try it yourself.</h2>
          <p className="sub" style={{ margin: "0 auto 4rem", maxWidth: "600px", textAlign: "center" }}>
            Read exactly how Calora speaks to your customers, or hit the button to have a real-time voice conversation with the AI right in your browser.
          </p>
          
          <div className="demos-grid">
            
            {/* Left: Static Script Demo */}
            <div className="static-demo-card">
              <div className="demo-header">
                <div className="demo-dot" />
                <div className="demo-dot" />
                <div className="demo-dot" />
                <span className="demo-header-title">Live Call Transcript</span>
              </div>
              <div className="demo-body">
                <div className="demo-line">
                  <div className="demo-avatar demo-avatar-ai">🤖</div>
                  <div className="demo-bubble demo-bubble-ai">
                    Hi Sarah! I noticed you left some items in your cart at Luxe Beauty. 
                    I'd love to help — can I offer you 15% off to complete your order?
                  </div>
                </div>
                <div className="demo-line demo-line-right">
                  <div className="demo-avatar demo-avatar-user">👤</div>
                  <div className="demo-bubble demo-bubble-user">
                    Oh really? I was on the fence about the serum. That sounds great!
                  </div>
                </div>
                <div className="demo-line">
                  <div className="demo-avatar demo-avatar-ai">🤖</div>
                  <div className="demo-bubble demo-bubble-ai">
                    Perfect! I just texted you a link with your discount code <strong style={{ color: "#a78bfa" }}>SAVE15</strong> applied. 
                    It's valid for 24 hours. Anything else I can help with?
                  </div>
                </div>
              </div>
            </div>

            {/* Right: Interactive Web Demo */}
            <div className="phone-frame interactive-frame">
...
/* Hero */
.hero{position:relative;z-index:10;display:flex;flex-direction:column;align-items:center;text-align:center;padding:9rem 2rem 4rem;min-height:70vh;justify-content:center}
...
.heading{font-size:clamp(2.8rem,6.5vw,5rem);font-weight:900;letter-spacing:-2.5px;line-height:1.08;max-width:850px;margin-bottom:1.5rem;color:#f4f4f5}
...
/* Demos Grid */
.demos-container{position:relative;z-index:10;padding:2rem 2rem 5rem;max-width:1200px;margin:0 auto}
.demos-grid{display:grid;grid-template-columns:1fr 1fr;gap:2rem;align-items:stretch}

/* Static Demo (Chat Bubbles) */
.static-demo-card{background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.05);border-radius:1.5rem;overflow:hidden;display:flex;flex-direction:column}
.demo-header{padding:1rem 1.5rem;border-bottom:1px solid rgba(255,255,255,0.05);display:flex;align-items:center;gap:0.5rem}
.demo-dot{width:8px;height:8px;border-radius:50%;background:rgba(255,255,255,0.1)}
.demo-header-title{margin-left:auto;color:#71717a;font-size:0.75rem;font-weight:600;text-transform:uppercase;letter-spacing:1px}
.demo-body{padding:2.5rem;display:flex;flex-direction:column;gap:1.25rem;flex:1}
.demo-line{display:flex;align-items:flex-start;gap:1rem}
.demo-avatar{width:32px;height:32px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:0.85rem;flex-shrink:0;margin-top:2px}
.demo-avatar-ai{background:linear-gradient(135deg,#7c3aed,#a78bfa)}
.demo-avatar-user{background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.1)}
.demo-bubble{padding:0.85rem 1.25rem;border-radius:1rem;font-size:0.95rem;line-height:1.55;max-width:90%}
.demo-bubble-ai{background:rgba(99,102,241,0.08);border:1px solid rgba(99,102,241,0.1);color:#d4bfff;border-top-left-radius:4px}
.demo-bubble-user{background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.06);color:#bbb;border-top-right-radius:4px}
.demo-line-right{flex-direction:row-reverse}

/* Interactive Demo */
.phone-frame{width:100%;background:linear-gradient(180deg,#14161e 0%,#101218 100%);border:1px solid rgba(255,255,255,0.06);border-radius:1.5rem;overflow:hidden;box-shadow:inset 0 1px 0 rgba(255,255,255,0.05)}
